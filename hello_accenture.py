...
class Application:
    def __init__(self, root):
        ...
        self.slides = [
            ...
            {
                "text": "I'm a software developer from Northampton massachusetts. I have experience in Javascript, React, Django, Postgresql, Mongoose, and more! I believe interacting with computers should be engaging and easy, and I love working on my craft. In My free time, i like playing guitar, painting and making pixel art, coding games, and playing with my cat.",
                "image": None,
                "widget": None,
            },
            {
            ...
            },
            {
                ...
                "image": None,
                "widget": ttk.Button(
                    self.root, text="pick a background color", command=self.update_color
                ),
            },
            {
            ...
            },
            {
                ...
                "widget": ttk.Button(
                    self.root,
                    text="DISPLAY CURRENT SLIDE #",
                    command=self.show_slide_number,
                ),
            },
            {
        ...
        self.label = ttk.Label(
            self.root,
            text=self.slides[self.current_slide]["text"],
            wraplength=325,
            justify="center",
        )
        ...
        self.previous_button = ttk.Button(
            self.root, text="Previous", command=self.show_previous, state=DISABLED
        )
        ...
        self.ball = self.animation_canvas.create_oval(
            10, 10, 30, 30, fill="red", tags="ball"
        )
    ...
    def animate(self):
        if self.ball is not None:
            ...
            self.animation_canvas.move(
                self.ball, self.animation_direction, self.animation_direction_y
            )
    ...
    def handle_slide(self):
        ...
        # Remove the previous image label from the screen if one exists
    ...
    def show_slide_number(self):
        ...
        messagebox.showinfo(
            title="Current Slide Number", message=f"You are on slide {slide_number}"
        )
